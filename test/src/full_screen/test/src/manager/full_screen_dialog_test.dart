...
void main() {
  testWidgets('show and hide', (widgetTester) async {
    ...
    easyOverlayState.dialogManagerProvider
        .showFullScreen(FullScreenDialog(content: _content));
    ...
    expect(easyOverlayState.box.get(FullScreenConversation),
    ...
    expect(easyOverlayState.box.get(FullScreenConversation), isNull);
  });
  ...
  testWidgets('show one, then show another', (widgetTester) async {
    ...
    expect(easyOverlayState.box.currentEntries.isNotEmpty, isTrue);
    expect(easyOverlayState.box.get(FullScreenConversation), isNotNull);
  });
}
